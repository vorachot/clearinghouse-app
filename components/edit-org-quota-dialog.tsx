...
type EditOrgQuotaDialogProps = {
  isOpen: boolean;
  quota: OrganizationQuota | null;
  isUpdating?: boolean;
  error?: string | null;
  onClose: () => void;
  onConfirm: (quotaId: string, data: UpdateOrganizationQuotaDTO) => void;
};

const EditOrgQuotaDialog = ({
  isOpen,
  quota,
  isUpdating = false,
  error,
    ...
    <Modal isOpen={isOpen} onClose={onClose} size="4xl" scrollBehavior="inside">
      <ModalContent>
        <ModalHeader className="flex items-center gap-2">
          ...
          <span>Edit Organization Quota</span>
        </ModalHeader>
        <ModalBody className="space-y-4">
          ...
          <Table aria-label="Edit organization quota resources">
            <TableHeader>
...
export default EditOrgQuotaDialog;
